...
const FAQ_CATEGORIES = [
  {
    ...
    items: [
      { question: "Как оформить заявку?", answer: "Оставьте заявку через форму на сайте, по телефону, в Telegram или WhatsApp. Оператор перезвонит, уточнит маршрут и подтвердит стоимость." },
