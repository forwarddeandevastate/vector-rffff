...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${SITE_URL}/kazan/ufa` },
  robots: { index: true, follow: true },
  openGraph: {
    type: "website",
    url: `${SITE_URL}/kazan/ufa`,
    title: `Такси Казань — ${TO_NAME} | Межгород 24/7`,
    description:
      `Трансфер Казань — ${TO_NAME}: комфортные авто, подача по времени, стоимость согласуем заранее. Заявка онлайн 24/7.`,
    siteName: SITE_NAME,
...
export default function Page() {
  ...
  const breadcrumbsJsonLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: `${TO_NAME}`, item: `${SITE_URL}/kazan/ufa` },
    ],
  };
  ...
  return (
    <>
      <Script
        id="ld-route-breadcrumbs-kazan-ufa"
        type="application/ld+json"
        strategy="beforeInteractive"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbsJsonLd) }}
      />
      <Script
        id="ld-route-faq-kazan-ufa"
        type="application/ld+json"
        strategy="beforeInteractive"
