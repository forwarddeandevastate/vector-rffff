...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${SITE_URL}/yaroslavl/smolensk` },
  robots: { index: true, follow: true },
  openGraph: {
    type: "website",
    url: `${SITE_URL}/yaroslavl/smolensk`,
    title: `Такси Ярославль — ${TO_NAME} | Межгород 24/7`,
    description:
      `Трансфер Ярославль — ${TO_NAME}: комфортные авто, подача по времени, стоимость согласуем заранее. Заявка онлайн 24/7.`,
    siteName: SITE_NAME,
...
export default function Page() {
  ...
  const breadcrumbsJsonLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: `${TO_NAME}`, item: `${SITE_URL}/yaroslavl/smolensk` },
    ],
  };
  ...
  return (
    <>
      <Script
        id="ld-route-breadcrumbs-yaroslavl-smolensk"
        type="application/ld+json"
        strategy="beforeInteractive"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbsJsonLd) }}
      />
      <Script
        id="ld-route-faq-yaroslavl-smolensk"
        type="application/ld+json"
        strategy="beforeInteractive"
