...
const routeExamples = [
  "Такси межгород Москва — Нижний Новгород",
      ...
      <main className="mx-auto max-w-4xl px-4 py-10 md:py-14">
        <div className="rounded-3xl border border-blue-100/60 bg-white/82 backdrop-blur-md p-6 shadow-sm md:p-8">
          ...
          <p className="mt-4 max-w-4xl text-base leading-7 text-slate-600">
            Такси межгород — это прямая поездка из одного города в другой без
            пересадок, вокзальной суеты и лишней логистики. Такой формат
            выбирают для деловых командировок, семейных поездок, трансферов на
            дальние расстояния и выездов с багажом. Автомобиль подаётся к
            нужному адресу, а едет прямо до пункта назначения — без промежуточных
            остановок и смены транспорта.
          </p>

          <p className="mt-4 max-w-4xl text-base leading-7 text-slate-600">
            Такси межгород особенно выгодно для групп: стоимость делится на
            всех пассажиров, а итоговая цена нередко сопоставима с билетами на
            поезд или дешевле. Кроме того, вы доезжаете прямо по адресу — не
            нужно брать городское такси с вокзала. Стоимость межгородской
            поездки согласовывается заранее, поэтому маршрут легко
            спланировать без сюрпризов.
          </p>
        ...
        <section className="mt-8 rounded-3xl border border-blue-100/60 bg-white p-6 shadow-sm">
          <h2 className="text-xl font-extrabold text-slate-900">
            Популярные межгородские маршруты
          </h2>
