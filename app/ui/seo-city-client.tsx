 ...
 * Рендерит форму заявки для городской страницы.
 * Форма LazyLoad — единственный use client в цепочке.
 */
  ...
  return (
    <div id="order" className="scroll-mt-24 lg:sticky lg:top-24 lg:self-start">
      <GlassPanel className="overflow-hidden">
        ...
        <div className="p-3">
          {/* CityFormIsland — единственный клиентский компонент */}
          <CityFormIsland cityName={cityName} initialFrom={initialFrom ?? cityName} />
        </div>
      </GlassPanel>
    </div>
  );
