...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${SITE_URL}/rostov-na-donu/samara` },
  robots: { index: true, follow: true },
  openGraph: {
    type: "website",
    url: `${SITE_URL}/rostov-na-donu/samara`,
    title: `Такси Ростов‑на‑Дону — ${TO_NAME} | Межгород 24/7`,
    description:
      `Трансфер Ростов‑на‑Дону — ${TO_NAME}: комфортные авто, подача по времени, стоимость согласуем заранее. Заявка онлайн 24/7.`,
    siteName: SITE_NAME,
...
export default function Page() {
  ...
  const breadcrumbsJsonLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: `${TO_NAME}`, item: `${SITE_URL}/rostov-na-donu/samara` },
    ],
  };
  ...
  return (
    <>
      <Script
        id="ld-route-breadcrumbs-rostov-na-donu-samara"
        type="application/ld+json"
        strategy="beforeInteractive"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbsJsonLd) }}
      />
      <Script
        id="ld-route-faq-rostov-na-donu-samara"
        type="application/ld+json"
        strategy="beforeInteractive"
