...
export const metadata: Metadata = {
  title: `Такси Челябинск — ${TO_NAME} | Межгород 24/7`,
  description:
    `Трансфер Челябинск — ${TO_NAME}: комфортные авто, подача по времени, стоимость согласуем заранее. Заявка онлайн 24/7.`,
  alternates: { canonical: `${SITE_URL}/chelyabinsk/yekaterinburg` },
  robots: { index: true, follow: true },
  openGraph: {
    type: "website",
    url: `${SITE_URL}/chelyabinsk/yekaterinburg`,
    title: `Такси Челябинск — ${TO_NAME} | Межгород 24/7`,
    description:
      `Трансфер Челябинск — ${TO_NAME}: комфортные авто, подача по времени, стоимость согласуем заранее. Заявка онлайн 24/7.`,
    siteName: SITE_NAME,
...
export default function Page() {
  ...
  const breadcrumbsJsonLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: `${TO_NAME}`, item: `${SITE_URL}/chelyabinsk/yekaterinburg` },
    ],
  };
  ...
  return (
    <>
      <Script
        id="ld-route-breadcrumbs-chelyabinsk-yekaterinburg"
        type="application/ld+json"
        strategy="beforeInteractive"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbsJsonLd) }}
      />
      <Script
        id="ld-route-faq-chelyabinsk-yekaterinburg"
        type="application/ld+json"
        strategy="beforeInteractive"
